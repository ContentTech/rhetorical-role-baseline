...
from data_utils import convert_judgement_data_to_json, yield_data, MyDataset, get_tokenizer
...
train_examples = convert_judgement_data_to_json(512, judgement_train_dir, crf_dict, span_dict, "")
...
dev_examples = convert_judgement_data_to_json(512, judgement_dev_dir, crf_dict, span_dict, "")
